 ...
 *
 */
public class AfirmaClienteTsaRfcTimeStampTest extends TestCase {
  /**
   ...
   */
  public AfirmaClienteTsaRfcTimeStampTest(String testName) {
    super(testName);
  }
  ...
  public static Test suite() {
    return new TestSuite(AfirmaClienteTsaRfcTimeStampTest.class);
  }
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      afirmaRFCTimeStampPlugin = (ITimeStampPlugin) PluginsManager.instancePluginByClass(
          AfirmaClienteTsaRfcTimeStampPlugin.class, packageBase, afirmaRfcProperties);
