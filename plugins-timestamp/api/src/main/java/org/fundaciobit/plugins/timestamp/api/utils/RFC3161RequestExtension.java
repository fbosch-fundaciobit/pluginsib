...
public final class RFC3161RequestExtension {
	...
	public RFC3161RequestExtension(final String oid, final boolean isCritical, final byte[] value) {
	...
	private RFC3161RequestExtension() {
		this.oid = null;
		this.critical = false;
		this.value = null;
	}
